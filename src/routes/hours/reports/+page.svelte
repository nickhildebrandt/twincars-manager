<script lang="ts">
  ...
  import { BarChart3, CalendarRange } from '@lucide/svelte'
  import {
    monthlyReportRemote,
  ...
  /** Report tabs (standard TabGroup, `?tab=` deep links). */
  const reportTabs: TabItem[] = [
    { id: 'utilization', label: 'Auslastung', icon: BarChart3 },
    { id: 'monthly', label: 'Monatsauswertung', icon: CalendarRange }
  ]
...
<TabGroup name="hours_reports_tabs" tabs={reportTabs}>
