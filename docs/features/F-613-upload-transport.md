...
base64-Data-URL im Command-Body, max. 60 000 000 Zeichen, min. 1024 Bytes dekodiert, `BODY_SIZE_LIMIT=64M`; temporäre Datei, nach Lauf gelöscht
...
- Inventar: [F-613 in 01-inventar.md](../rewrite/01-inventar.md)
