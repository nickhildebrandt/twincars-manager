...
# F-076 — Benutzer deaktivieren/reaktivieren
...
Toggle ohne Dialog, optimistisch; Deaktivierung löscht Sessions; letzter Wildcard-Inhaber nicht deaktivierbar (409)
...
- Inventar: [F-076 in 01-inventar.md](../rewrite/01-inventar.md)
