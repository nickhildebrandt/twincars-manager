...
# F-311 — Berechtigungen und Navigation
...
Katalog und Lager unter `tires`; Erinnerungen unter `settings`; Sidebar-Einträge „Reifenkatalog" und „Reifenlager"
...
- Inventar: [F-311 in 01-inventar.md](../rewrite/01-inventar.md)
