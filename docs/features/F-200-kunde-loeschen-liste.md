---
id: F-200
title: Kunde löschen (Liste)
status: geplant
modul: Kunden und Lieferanten
paket: T-011
permission: offen
routes: ['/customers']
endpoints: ['deleteCustomerRemote']
tables: ['customers']
schemas: []
components: []
tests: []
...
ConfirmDialog danger; optimistischer Single-Flight; Toast `Kunde „…" gelöscht.`; nur aus der Liste
...
- Inventar: [F-200 in 01-inventar.md](../rewrite/01-inventar.md)
