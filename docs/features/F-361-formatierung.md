...
Datum `Intl.DateTimeFormat('de-DE',{dateStyle:'medium'})`, Datum+Zeit `timeStyle:'short'`, Beträge `formatEuro`, Mengen 0–3 Dezimalstellen; Auftragsnummer monospace
...
- Inventar: [F-361 in 01-inventar.md](../rewrite/01-inventar.md)
