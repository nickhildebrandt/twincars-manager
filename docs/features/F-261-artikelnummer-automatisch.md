---
id: F-261
title: Artikelnummer automatisch
status: geplant
modul: Artikel, Reifenkatalog, Reifeneinlagerung, Etiketten
paket: T-014
permission: offen
routes: []
endpoints: ['nextArticleNumber']
tables: ['items']
schemas: []
components: []
tests: []
...
# F-261 — Artikelnummer automatisch
...
Format `ART-00001`, fortlaufend aus der Zeilenzahl; manuelle Eingabe möglich
...
- Inventar: [F-261 in 01-inventar.md](../rewrite/01-inventar.md)
