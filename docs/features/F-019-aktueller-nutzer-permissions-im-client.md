---
id: F-019
title: Aktueller Nutzer + Permissions im Client
status: geplant
...
# F-019 — Aktueller Nutzer + Permissions im Client
...
Aktueller Nutzer + Permissions im Client
...
- Inventar: [F-019 in 01-inventar.md](../rewrite/01-inventar.md)
