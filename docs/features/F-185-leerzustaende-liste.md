...
"Noch keine Kunden" (+ Button) bzw. "Keine archivierten Kunden"; kein separater "Keine Treffer"-Zustand
...
- Inventar: [F-185 in 01-inventar.md](../rewrite/01-inventar.md)
