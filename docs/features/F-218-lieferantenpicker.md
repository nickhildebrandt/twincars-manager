---
id: F-218
title: Lieferantenpicker
status: geplant
modul: Kunden und Lieferanten
paket: T-011
permission: offen
routes: []
endpoints: ['pickSuppliersRemote']
tables: ['suppliers']
schemas: []
components: []
tests: []
...
Aktive, ILIKE name/city/contactPerson/email, `name ASC`, Label `Name · Ort`; **kein Konsument**
...
- Inventar: [F-218 in 01-inventar.md](../rewrite/01-inventar.md)
