...
endpoints: ['createSupplierRemote']
tables: ['suppliers']
schemas: []
components: []
tests: []
...
Firmenname Pflicht (client); Land Default "Deutschland"; IBAN/BIC serverseitig geprüft (mod-97 / 8-11 Zeichen); Toast "Lieferant angelegt."; Redirect Detail
...
- Inventar: [F-213 in 01-inventar.md](../rewrite/01-inventar.md)
