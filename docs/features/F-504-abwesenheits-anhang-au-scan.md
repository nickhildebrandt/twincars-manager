---
id: F-504
title: Abwesenheits-Anhang (AU-Scan)
status: geplant
...
tables: ['employee_absences.attachment_*']
schemas: []
components: []
tests: []
updated: 2026-09-13
...
# F-504 — Abwesenheits-Anhang (AU-Scan)
...
Abwesenheits-Anhang (AU-Scan)

## Erwartetes Verhalten

Schema/Spalten vorhanden; kein Upload, keine Anzeige, kein Download
...
| Routen | — |
| Endpoints | `createAbsenceRemote` |
| Tabellen | `employee_absences.attachment_*` |
| Schemata | _offen_ |
| Tests | _offen_ |
...
- Inventar: [F-504 in 01-inventar.md](../rewrite/01-inventar.md)
