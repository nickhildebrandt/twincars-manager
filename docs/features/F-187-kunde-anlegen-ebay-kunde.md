---
id: F-187
title: Kunde anlegen (eBay-Kunde)
status: geplant
...
# F-187 — Kunde anlegen (eBay-Kunde)
...
Kunde anlegen (eBay-Kunde)

## Erwartetes Verhalten

Radio "eBay-Kunde"; nur eBay-Name (3..100, Pflicht client), Name (optional → `firstName`), Opt-ins; `kind='ebay'`
...
- Inventar: [F-187 in 01-inventar.md](../rewrite/01-inventar.md)
