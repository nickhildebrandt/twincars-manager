...
9 kinds per Seed (Tabelle §3.4) + `tire` nur per Migration/Service-Default; alle bei 1; Import verschiebt Zähler.
...
- Inventar: [F-154 in 01-inventar.md](../rewrite/01-inventar.md)
