---
id: F-267
title: Artikel-Detail Preise und Lager
status: geplant
modul: Artikel, Reifenkatalog, Reifeneinlagerung, Etiketten
paket: T-014
permission: offen
routes: ['/items/[id]']
endpoints: ['getItemRemote']
...
# F-267 — Artikel-Detail Preise und Lager
...
Artikel-Detail Preise und Lager

## Erwartetes Verhalten

VK netto (aktuelle Version), EK netto, Bestand
...
- Inventar: [F-267 in 01-inventar.md](../rewrite/01-inventar.md)
