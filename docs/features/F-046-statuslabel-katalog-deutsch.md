---
id: F-046
title: Statuslabel-Katalog (deutsch)
status: geplant
...
# F-046 — Statuslabel-Katalog (deutsch)
...
Statuslabel-Katalog (deutsch)

## Erwartetes Verhalten

Label+Badge je Status-Domäne; unbekannt → „-“
...
- Inventar: [F-046 in 01-inventar.md](../rewrite/01-inventar.md)
