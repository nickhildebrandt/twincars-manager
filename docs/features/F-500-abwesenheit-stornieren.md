...
permission: offen
routes: ['/employees/[id]']
endpoints: ['updateAbsenceRemote({ status: 'cancelled' })']
...
Optimistischer Status-Flip; Zeile bleibt sichtbar mit Badge "Abgesagt", zählt 0 Tage; kein Rückgängig in UI
...
- Inventar: [F-500 in 01-inventar.md](../rewrite/01-inventar.md)
