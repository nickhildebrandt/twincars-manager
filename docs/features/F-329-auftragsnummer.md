...
permission: offen
routes: []
endpoints: ['allocateNumber('work_order')']
...
`AU-{YYYY}-{NNNN}`, atomar (`UPDATE ... RETURNING`), per Migration und `seedDefaults` geseedet; UNIQUE
...
- Inventar: [F-329 in 01-inventar.md](../rewrite/01-inventar.md)
