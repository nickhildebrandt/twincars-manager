---
id: F-446
title: Legacy-Deep-Links `/settings?tab=mail|reminders|smtp` → Redirect
status: geplant
...
# F-446 — Legacy-Deep-Links `/settings?tab=mail|reminders|smtp` → Redirect
...
Legacy-Deep-Links `/settings?tab=mail|reminders|smtp` → Redirect
...
- Inventar: [F-446 in 01-inventar.md](../rewrite/01-inventar.md)
