...
paket: T-031
permission: offen
routes: ['/api/public/tires/[id]']
endpoints: ['handlePublicTireDetail', 'getPublicTire']
tables: []
schemas: []
components: []
tests: []
...
UUID (400), 404 wenn unbekannt oder nicht `online_sellable`
...
- Inventar: [F-565 in 01-inventar.md](../rewrite/01-inventar.md)
