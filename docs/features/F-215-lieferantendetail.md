...
Karten Anschrift/Kontakt, Bankdaten nur bei Inhalt; ohne Kontaktperson/Kundennr./Notiz
...
- Inventar: [F-215 in 01-inventar.md](../rewrite/01-inventar.md)
