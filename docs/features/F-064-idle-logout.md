...
60 min ohne Aktivität (5 Event-Typen), einmaliges Feuern, Reload auf `/login?reason=idle`, nur für angemeldete Nutzer
...
- Inventar: [F-064 in 01-inventar.md](../rewrite/01-inventar.md)
