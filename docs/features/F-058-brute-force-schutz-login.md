...
# F-058 — Brute-Force-Schutz Login
...
10 POST/min/IP (XFF-first), 429 + `Retry-After`, GET und andere Auth-Pfade unlimitiert
...
- Inventar: [F-058 in 01-inventar.md](../rewrite/01-inventar.md)
