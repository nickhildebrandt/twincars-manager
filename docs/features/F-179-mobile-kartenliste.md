...
Mobile Kartenliste (< `lg`)

## Erwartetes Verhalten

`<a>`-Zeilen mit Label, Nummer, `Ort · Telefon` bzw. eBay-Handle/Datum; Aktionen als Sibling
...
- Inventar: [F-179 in 01-inventar.md](../rewrite/01-inventar.md)
