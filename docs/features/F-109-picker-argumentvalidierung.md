---
id: F-109
title: Picker-Argumentvalidierung
status: geplant
...
# F-109 — Picker-Argumentvalidierung
...
Picker-Argumentvalidierung

## Erwartetes Verhalten

`q` trim ≤ 200, `size ∈ {10,25,50,100}`, `page` Zahl; Rückgabe `{items,total,page,size,pageCount≥1}`
...
- Inventar: [F-109 in 01-inventar.md](../rewrite/01-inventar.md)
