...
Erst-Request-Seeding

## Erwartetes Verhalten

Einmal pro Prozess, idempotent; jeder Request wartet auf das Seed-Promise
...
- Inventar: [F-006 in 01-inventar.md](../rewrite/01-inventar.md)
