---
id: F-387
title: Rechnungsdetail: Positionen, Summen, Endtext
status: geplant
...
# F-387 — Rechnungsdetail: Positionen, Summen, Endtext
...
Rechnungsdetail: Positionen, Summen, Endtext

## Erwartetes Verhalten

Menge de-DE formatiert; Datum dd.mm.yyyy; Rabatt-Summe; keyed Layout für Storno-Navigation
...
- Inventar: [F-387 in 01-inventar.md](../rewrite/01-inventar.md)
