---
id: F-450
title: Art-Filter Alle/Einnahmen/Ausgaben
status: geplant
modul: Buchhaltung, Kategorien, DATEV-Export
paket: T-028
permission: offen
routes: ['/ledger']
endpoints: ['listLedgerEntriesRemote(direction)']
...
# F-450 — Art-Filter Alle/Einnahmen/Ausgaben
...
Art-Filter Alle/Einnahmen/Ausgaben

## Erwartetes Verhalten

`all` = kein Filter; Wechsel setzt Seite → 1; Filter wirkt auch auf Summen
...
- Inventar: [F-450 in 01-inventar.md](../rewrite/01-inventar.md)
