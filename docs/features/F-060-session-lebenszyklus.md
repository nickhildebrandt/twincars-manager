...
7 Tage, Verlängerung nach 1 Tag Aktivität, Cookie-Cache 5 min, Cookies `tcm.*` httpOnly/lax/secure(https)
...
- Inventar: [F-060 in 01-inventar.md](../rewrite/01-inventar.md)
