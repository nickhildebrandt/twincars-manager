...
paket: T-016
permission: offen
routes: ['/tire-storage/scan/[number]']
endpoints: ['resolveTireStorageByNumberRemote']
tables: ['tire_storage']
schemas: []
components: []
tests: []
...
löst Nummer auf und leitet auf das Detail um; unbekannte Nummer ergibt 404
...
| | |
| --- | --- |
| Routen | `/tire-storage/scan/[number]` |
| Endpoints | `resolveTireStorageByNumberRemote` |
...
- Inventar: [F-305 in 01-inventar.md](../rewrite/01-inventar.md)
