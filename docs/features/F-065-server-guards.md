...
permission: offen
routes: []
endpoints: ['requireUser', 'requirePermission', 'requireAnyPermission']
tables: []
schemas: []
components: []
tests: []
...
401 „Bitte melden Sie sich an." / 403 „Keine Berechtigung für diese Aktion."; erste Anweisung jedes Remote-Bodys (Ausnahmen: layout, setup)
...
- Inventar: [F-065 in 01-inventar.md](../rewrite/01-inventar.md)
