---
id: F-156
title: Seed Ledger-Kategorien (13)
status: geplant
...
# F-156 — Seed Ledger-Kategorien (13)
...
Seed Ledger-Kategorien (13)

## Erwartetes Verhalten

3 income, 10 expense (Namen §3.4); unique `name`.
...
- Inventar: [F-156 in 01-inventar.md](../rewrite/01-inventar.md)
