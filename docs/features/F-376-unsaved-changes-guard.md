...
`formDirty.set(true)` auf input/change; clear vor `goto` nach Save; Convert-Seite ohne Guard
...
- Inventar: [F-376 in 01-inventar.md](../rewrite/01-inventar.md)
