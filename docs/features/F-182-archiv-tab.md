...
permission: offen
routes: ['/customers']
endpoints: ['listCustomersRemote', 'archived:'archived'']
...
Nur archivierte Kunden **aller Kinds** (Kind-Filter ignoriert, `kind:'all'` gesendet); Badge; Inline-Reaktivieren; eigener Leerzustand
...
- Inventar: [F-182 in 01-inventar.md](../rewrite/01-inventar.md)
