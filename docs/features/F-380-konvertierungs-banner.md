...
Konvertierungs-Banner

## Erwartetes Verhalten

„In Rechnung überführt" + Link „Zur Rechnung" wenn `converted` / `convertedToInvoiceId`
...
- Inventar: [F-380 in 01-inventar.md](../rewrite/01-inventar.md)
