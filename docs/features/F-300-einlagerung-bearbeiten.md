---
id: F-300
title: Einlagerung bearbeiten
status: geplant
modul: Artikel, Reifenkatalog, Reifeneinlagerung, Etiketten
paket: T-016
permission: offen
routes: ['/tire-storage/[id]/edit']
endpoints: ['updateTireStorageRemote']
tables: ['tire_storage']
schemas: []
components: []
tests: []
...
- Inventar: [F-300 in 01-inventar.md](../rewrite/01-inventar.md)
