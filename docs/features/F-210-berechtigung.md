...
Berechtigung `customers`

## Erwartetes Verhalten

Ein Schlüssel für Lesen/Schreiben/Löschen; Aufträge-Tab zusätzlich mit `orders`; Sidebar gefiltert; Wildcard `*`
...
- Inventar: [F-210 in 01-inventar.md](../rewrite/01-inventar.md)
