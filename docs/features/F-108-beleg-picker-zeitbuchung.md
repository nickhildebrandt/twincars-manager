---
id: F-108
title: Beleg-Picker (Zeitbuchung)
status: geplant
modul: Gemeinsame UI-Komponenten und Picker
paket: T-009
permission: offen
routes: []
endpoints: ['pickDocumentsRemote']
...
# F-108 — Beleg-Picker (Zeitbuchung)
...
Beleg-Picker (Zeitbuchung)

## Erwartetes Verhalten

Typen invoice/offer/cost_estimate/order_confirmation; neueste zuerst; Label `Typ Nummer · Kunde`
...
- Inventar: [F-108 in 01-inventar.md](../rewrite/01-inventar.md)
