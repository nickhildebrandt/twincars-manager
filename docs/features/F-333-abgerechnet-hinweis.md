...
`alert-success` "Dieser Auftrag ist abgeschlossen und abgerechnet: Rechnung {nr}" (Link) bei `done && invoiceId`
...
- Inventar: [F-333 in 01-inventar.md](../rewrite/01-inventar.md)
