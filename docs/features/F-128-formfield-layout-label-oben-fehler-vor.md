---
id: F-128
title: FormField-Layout (Label oben, ` *`, Fehler vor Hint, `colSpan`)
status: geplant
...
# F-128 — FormField-Layout (Label oben, ` *`, Fehler vor Hint, `colSpan`)
...
FormField-Layout (Label oben, ` *`, Fehler vor Hint, `colSpan`)

## Erwartetes Verhalten

ein `<label>` um das Feld
...
- Inventar: [F-128 in 01-inventar.md](../rewrite/01-inventar.md)
