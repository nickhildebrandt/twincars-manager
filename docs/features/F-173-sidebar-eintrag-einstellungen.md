---
id: F-173
title: Sidebar-Eintrag Einstellungen
status: geplant
...
# F-173 — Sidebar-Eintrag Einstellungen
...
Sidebar-Eintrag Einstellungen

## Erwartetes Verhalten

Gruppe System, Permission `settings`, Icon `Settings`; „Anfragen" separat in Kommunikation (`mailings`).
...
- Inventar: [F-173 in 01-inventar.md](../rewrite/01-inventar.md)
